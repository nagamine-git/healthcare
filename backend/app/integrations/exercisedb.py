...
# 値は ExerciseDB に **実在する名前** (本番プローブで確認済み)。name エンドポイントは
# 部分一致なので、ダンベル/自重の実在バリアントに合わせてある。
_JA_TO_EN: dict[str, str] = {
    ...
    "自重スクワット": "dumbbell squat",
    "ブルガリアンスクワット": "dumbbell single leg squat",
    "ブルガリアン": "dumbbell single leg squat",
    "ピストルスクワット": "single leg squat (pistol)",
    "ダンベルフライ": "dumbbell fly",
    "サイドレイズ": "dumbbell full can lateral raise",
    "ダンベルフレンチプレス": "dumbbell one arm french press",
