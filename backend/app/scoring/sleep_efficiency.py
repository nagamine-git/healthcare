...
CAVEATS: list[str] = [
    ...
    # ⚠️ これが無いと「長く寝た夜ほど BB が低い」を「長く寝ると回復が悪い」と読んでしまう。
    # 観察データでは因果の向きが逆でありうる (不調・疲労・体調不良の日ほど長く寝る)。
    "長く寝た夜ほど回復指標が低く見えることがありますが、因果の向きは逆かもしれません"
    "(疲れている日・体調が悪い日ほど長く眠るため)。"
    "「長く寝たから回復しなかった」ではなく「回復が必要な日だったから長く寝た」"
    "という説明が同じデータに当てはまります。観察データからはこの2つを区別できません。",
]
