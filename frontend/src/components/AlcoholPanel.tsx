    ...
    <div className="rounded-2xl bg-slate-900/70 p-4 sm:p-6">
      ...
      >
        <div className="flex items-baseline gap-3">
          <h3 className="text-sm tracking-wider text-slate-300">アルコール記録</h3>
...
function PresetRow({
  ...
  return (
    ...
    >
      <span className="w-40 shrink-0 text-xs text-slate-200">{label}</span>
      <input
        type="number"
        inputMode="decimal"
        min={0.1}
...
function ManualInput({
  ...
  return (
    <form
      ...
      className="flex items-center gap-2"
    >
      <span className="w-40 shrink-0 text-xs text-slate-200">g 直接</span>
      <input
        type="number"
        inputMode="decimal"
        min={1}
        ...
        className="w-16 rounded border border-slate-700 bg-slate-900 px-2 py-1 text-right text-xs text-slate-200 tabular-nums focus:border-amber-500 focus:outline-none"
      />
      <span className="w-12 shrink-0 text-[10px] text-slate-500">g</span>
      <span className="ml-auto w-16 text-right font-mono text-xs tabular-nums text-amber-400/70">
...
function IntakeList({
  ...
  return (
    <div className="mt-3 rounded-xl border border-slate-800 bg-slate-900/40 p-3">
      <div className="mb-2 flex items-baseline justify-between text-[10px] uppercase tracking-wider text-slate-500">
        <span>直近 7 日の記録</span>
